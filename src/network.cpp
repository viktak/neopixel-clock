...
namespace network
{
    ...
    void handleGeneralSettings()
    {
        ...
        { //  POST
            ...
            {
                strcpy(settings::mqttTopic, webServer.arg("mqtttopic").c_str());
            }
    ...
    void handleClock()
    {
        ...
        { //  POST
            ...
            if (webServer.hasArg("trailselector"))
            {
                settings::trailLength = webServer.arg("trailselector").toInt();
            }

            if (webServer.hasArg("reverse"))
            {
            ...
            if (webServer.hasArg("showfivemark"))
            {
            ...
            if (webServer.hasArg("showseconds"))
            {
            ...
            if (webServer.hasArg("fiveMinuteMarkBrightness"))
            {
                settings::fiveMinuteMarkBrightness = webServer.arg("fiveMinuteMarkBrightness").toInt();
            }

            if (webServer.hasArg("ledMaxBrightness"))
            {
                settings::ledMaxBrightness = webServer.arg("ledMaxBrightness").toInt();
            }

            if (webServer.hasArg("lastofTrailBrightness"))
            {
                settings::lastOfTrailBrightness = webServer.arg("lastofTrailBrightness").toInt();
            }
            settings::SaveSettings();
        }
        ...
        File f = LittleFS.open("/clock.html", "r");

        String htmlString, traillist, chkreverse, chkfiveminute, chkshowseconds;
        ...
        if (settings::showFiveMinuteMarks)
            chkfiveminute += "checked=";
        chkfiveminute += "/>";

        chkshowseconds = "<input type="
                         "checkbox"
                         " name="
                         "showseconds"
                         " id="
        ...
        if (settings::showSeconds)
            chkshowseconds += "checked=";
        chkshowseconds += "/>";

        htmlString.replace("%year%", (String)year(localTime));
        htmlString.replace("%traillist%", traillist);
        htmlString.replace("%chkreverse%", chkreverse);
        htmlString.replace("%chkfiveminute%", chkfiveminute);
        htmlString.replace("%chkshowseconds%", chkshowseconds);
        htmlString.replace("%fiveMinuteMarkBrightness%", (String)settings::fiveMinuteMarkBrightness);
        htmlString.replace("%ledMaxBrightness%", (String)settings::ledMaxBrightness);
        htmlString.replace("%lastofTrailBrightness%", (String)settings::lastOfTrailBrightness);
    ...
    void InitWifiWebServer()
    {
        ...
        webServer.on("/clock.html", handleClock);
